describe('Register a customer', function () {
	it('Register a customer with a blank country. Shouldnt redirect nor insert customer in DB.', function (){
		...
		element(by.model('customer.email')).sendKeys('newmail8@mail.com');
