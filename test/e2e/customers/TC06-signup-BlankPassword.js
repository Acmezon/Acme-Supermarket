describe('Register a customer', function () {
	it('Register a customer with a blank password. Shouldnt redirect nor insert a customer in DB.', function (){
		...
		element(by.model('customer.email')).sendKeys('newmail6@mail.com');
